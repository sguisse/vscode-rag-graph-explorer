...
export const Footer: React.FC<FooterProps> = ({ status, progress, onKill }) => {
    ...
    return (
        <footer className="z-40 relative flex flex-shrink-0 justify-between items-center bg-[var(--vscode-editorGroupHeader-viewsBackground)] shadow-[0_-3px_8px_rgba(0,0,0,0.24)] px-4 border-[var(--vscode-panel-border)] border-t h-8 text-[var(--vscode-descriptionForeground)] text-xs select-none" >

            {/* left data quadrant */}
            <div id="footer-status-quadrant" className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2 animate-fadeIn">
                        {progress.total > 0 ? (
                            <>
                                ...
                                <div id="footer-progress-counter" className="relative flex justify-center items-center bg-[var(--vscode-input-background)] shadow-inner border border-[var(--vscode-input-border)] rounded w-44 h-4.5 overflow-hidden font-mono font-bold text-[10px] text-[var(--vscode-input-foreground)]">
                                    <div
                            ...
                            <span className="flex items-center gap-1 opacity-80 font-semibold text-[10px] text-orange-400 uppercase tracking-wider animate-pulse">
                ...
                <div id="footer-engine-status-indicator" className="flex items-center gap-1.5 bg-[var(--vscode-editor-background)]/50 py-0.5 font-semibold text-[11px]">
