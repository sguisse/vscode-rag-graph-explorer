        ...
        <div className="z-10 relative space-y-5 max-w-2xl">
          <div className="flex items-center gap-3">
            <img
              src={logoMax}
              alt="App Logo"
              className="drop-shadow-md w-auto h-10 object-contain"
            />
          ...
          <h1 className="font-extrabold text-foreground text-3xl sm:text-4xl leading-tight tracking-tight">
            ...
            <span className="inline-block bg-clip-text [-webkit-background-clip:text] bg-gradient-to-r from-emerald-500 via-primary to-blue-500 text-transparent font-extrabold">
              Minimum Token Usage.
            </span>
          </h1>
