...
# Update FiltersSection.tsx to replace "Max File (scope xxxx)" with "Scope Max File"
...
echo "✅ refactor: Updated Max File input label to 'Scope Max File' in FiltersSection!"
