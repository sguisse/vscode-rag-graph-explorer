...
# Update transformer-panel.tsx with matching column text colors for input fields
cat << 'EOF' > webview/src/features/explorer/wkp-rgt-tabs-files-context/transformer-panel.tsx
...
echo "✅ style: Updated rule input field text colors to match their corresponding table columns (Amber, Emerald, Indigo)!"
npm run build
