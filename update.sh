...
echo "📐 Updating layout of Selected Files Context card to give Token Size a wider column span..."
...
echo "✅ style: Token Size block now spans 4/10 width while Selected, Upstream, and Downstream each take 2/10!"
