...
echo "🚀 Updating InstallPanel component layout with responsive multi-column masonry & vertical overflow..."

# Ensure target directory exists
mkdir -p webview/src/features/install/components

# Write updated InstallPanel.tsx
cat << 'EOF' > webview/src/features/install/components/InstallPanel.tsx
...
echo "✅ fix: Updated InstallPanel cards layout to CSS multi-column masonry to eliminate vertical gaps between card rows and enable smooth flex scrolling!"
