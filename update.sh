...
# S'assurer que le dossier core existe
mkdir -p scripts/core

# ============================================================================
# MISE À JOUR DE SCRIPTS/CORE/MAIN.PY POUR INJECTER L'INSTALLATION DU CŒUR
# ============================================================================
...
# Recompilation de l'extension VS Code pour valider la chaîne
npm run compile

echo "✅ fix: scripts/core/main.py mis à jour et recompilé avec succès."
