...
echo "🚀 Fixing React JSX attribute errors in ExtensionConflictDialog.tsx (class -> className)..."

# 1. Ensure target directory exists
mkdir -p webview/src/features/exporter/components

# 2. Re-write ExtensionConflictDialog.tsx with correct className attributes
...
echo "✅ fix: Replaced native 'class' attributes with JSX-compliant 'className' attributes in ExtensionConflictDialog.tsx!"
