...
EXTENSION_FILE="backend/src/extension.ts"

if [ ! -f "$EXTENSION_FILE" ]; then
    EXTENSION_FILE="/Users/mac-SGUISS21/01-work/01-projects/10-tools/01-plugins/01-vscode/vscode-rag-graph-explorer/backend/src/extension.ts"
fi
...
echo "✅ Webview disposal state management fixed in extension.ts! currentPanel and AbstractServiceAdapter active webview are now properly reset to undefined on dispose."
