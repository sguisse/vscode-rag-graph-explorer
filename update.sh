...
# Overwrite ReferencesTable.tsx with the corrected import path for useAppContextStore
cat << 'EOF' > webview/src/components/app/project-references/components/ReferencesTable.tsx
...
echo "✅ fix: Fixed store import path to @/store/useAppContextStore resolving TypeScript build errors!"
