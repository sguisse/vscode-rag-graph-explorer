...
echo "🚀 Renaming title in ReportTreePanel to 'Exported files manifest'..."

# 1. Ensure target directory exists
mkdir -p webview/src/features/exporter/components/tabs/report

# 2. Update ReportTreePanel.tsx with the updated title "Exported files manifest"
cat << 'EOF' > webview/src/features/exporter/components/tabs/report/ReportTreePanel.tsx
...
echo "✅ refactor: Successfully renamed manifest panel title to 'Exported files manifest'!"
