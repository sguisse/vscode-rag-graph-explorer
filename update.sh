...
echo "✅ feat/refactor: Diagnostics output (effective configuration and available rules) are now stored in dedicated text files within '.graph-rag-explorer/target/install_reports/java_jqassistant'."
