...
export enum RpcMethodEnum {
    ...
    MATURITYMATRIX_REFRESH_ASSESSMENTS = 'refreshAssessments',
    MATURITYMATRIX_GET_LAST_ASSESSMENTS = 'getLastAssessments',
    MATURITYMATRIX_GET_ASSESSMENTS_AT = 'getAssessmentsAt',
    MATURITYMATRIX_GET_ASSESSMENTS_AVAILABLE = 'getAssessmentsAvailable',
