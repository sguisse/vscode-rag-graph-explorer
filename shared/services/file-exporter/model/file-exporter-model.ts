...
export interface ExportReportData {
  ...
  codebase?: SingleScopeReportData;
  reference?: SingleScopeReportData;
}
...
export type HistoryClearMode = 'remove-selected-hard' | 'remove-selected-soft' | 'clear-all-hard' | 'clear-all-soft';
