...
export interface IFilesExporterHistoryServicePort {
  ...
  saveHistory(formData: any, currentHistoryId: string | undefined, repo: string): Promise<HistorySaveResult>;
  ...
  softClearHistory(): Promise<string | undefined>;
