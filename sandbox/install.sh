#!/usr/bin/env bash
# ============================================================================
# Vite/Esbuild JSX Syntax Error Fix Script
# Action: Formats GraphPanelHeader.tsx to clean multi-line JSX syntax,
# eliminating inline JSX ambiguous tokens and unterminated regex parser errors.
# ============================================================================

set -e

mkdir -p src/features/explorer/wksp-cnt-graph
...
echo "✅ fix: Resolved esbuild JSX inline syntax parsing error in GraphPanelHeader.tsx!"
npm run build
