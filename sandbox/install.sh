#!/usr/bin/env bash
# ============================================================================
# VS Code Webview Extension Layout TypeScript Interface Fix Script
# Action: Restores structural integrity by adding missing 'sidebarLeftMode' prop
# to HeaderProps type definition inside src/components/app/layout/header.tsx.
# ============================================================================

set -e

# Overwrite header.tsx to align HeaderProps interface declaration with parent parameters
...
echo "✅ feat/fix: Added missing 'sidebarLeftMode' field into HeaderProps interface compilation contracts to eliminate TypeScript parameter mismatch assignment errors!"
