...
# Overwrite index.css to tune sidebar selection token properties to look identical to the primary header toggles
...
:root {
  ...
  /* Sidebar Selection Alignment: text-primary bg-primary/10 look and feel */
...
.dark {
  ...
  /* Dark mode sidebar active state optimization */
...
echo "✅ style/sidebar-colors: Configured sidebar active selection tokens with transparent blue hues and matching subtle hued hover states!"
