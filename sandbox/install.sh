...
# 1. Overwrite ExplorerFeature.tsx to completely remove the generatedMarkdownRecipe calculation and clean up its propagation
...
# 2. Overwrite inspector-tab-panel.tsx to accept state variables and compute the markdown recipe locally via useMemo
...
echo "✅ refactor: moved generatedMarkdownRecipe useMemo hook securely into inspector-tab-panel.tsx"
