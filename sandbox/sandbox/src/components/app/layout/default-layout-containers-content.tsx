...
// Store tracking active version ("1" or "2") for each region
...
/* Default layout containers map exported for initial application render */
...
export const defaultWorkspaceContainersContent = defaultLayoutContainersContent;
