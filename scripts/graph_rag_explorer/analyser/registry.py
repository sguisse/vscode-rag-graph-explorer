...
class AnalyserRegistry:
    ...
    @classmethod
    def register_analyser(cls, analyser_cls: Type[BaseAnalyser]):
        cls._analysers.append(analyser_cls)
        return analyser_cls

    @classmethod
    def get_analysers(cls) -> List[Type[BaseAnalyser]]:
        return cls._analysers

    @classmethod
    def discover_and_load_analysers(cls, analyser_root_dir: str):
            ...
            if "analyzer.py" in files:
                ...
                if spec and spec.loader:
                    ...
                    try:
                        ...
                        sys.stderr.write(f"[-] Execution failure during multi-threaded crawling on analyzer node {file_path}: {e}\n")
