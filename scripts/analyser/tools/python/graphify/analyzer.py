...
class GraphifyAstAnalyzer(BaseAnalyser):
    @property
    def name(self) -> str: return "graphify_ast_analyzer"
    ...
    def run_analysis(self, neo4j_client: Neo4jClient) -> None:
        ...
        # info(f"[Graphify Analyzer] Injecting AST mappings using external options: {active_args}", component=self.name)
