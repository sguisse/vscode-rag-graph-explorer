...
export const initialCodebase: CodebaseData = (codebaseJson as unknown) as CodebaseData;
  ...
  files: [
    {
      ...
      attributes: [{ name: 'disabled: boolean', visibility: 'private' }, { name: 'cartTotal: number', visibility: 'private' }],
      methods: [
        { id: 'onClick', name: 'onClick()', visibility: 'public', description: "Intercepts UI click events and triggers API client methods sequentially." },
        { id: 'render', name: 'render()', visibility: 'public', description: "Computes component visual tree using current reactive hook updates." }
      ]
    },
    {
      ...
      methods: [
        { id: 'placeOrder', name: 'placeOrder(items)', visibility: 'public', description: "Assembles fetch payloads and opens connections to backend proxy controller mapping paths." }
      ]
    },
    {
      ...
      methods: [
        { id: 'createOrder', name: 'createOrder(dto)', visibility: 'public', description: "Deserializes data context structures, verifies authentication parameters, and applies updates." }
      ]
    },
    {
    ...
    },
    {
      ...
      attributes: [],
      methods: [
        { id: 'save', name: 'save(order)', visibility: 'public', description: "Declarative persistence specifications handled via ORM schema configurations." }
      ]
    },
    {
      ...
      attributes: [{ name: 'entityManager: EntityManager', visibility: 'public' }],
      methods: [
        { id: 'save', name: 'save(order)', visibility: 'public', description: "Resolves transaction states and commits object properties directly down to database stacks." }
      ]
    },
    {
