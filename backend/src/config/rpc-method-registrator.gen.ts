...
export function registerRpcMethods(rpc: RpcProtocol): void {
    ...
    const fileExporterHistoryService = serviceRegistry.get(ServiceEnum.FILE_EXPORTER_HISTORY);
    rpc.register(RpcMethodEnum.FILEEXPORTERHISTORY_GET_FULL_WRAPPER, fileExporterHistoryService.getFullWrapper.bind(fileExporterHistoryService));
    rpc.register(RpcMethodEnum.FILEEXPORTERHISTORY_LOAD_HISTORY, fileExporterHistoryService.loadHistory.bind(fileExporterHistoryService));
    rpc.register(RpcMethodEnum.FILEEXPORTERHISTORY_GET_LAST_RUN_CONFIG_ID, fileExporterHistoryService.getLastRunConfigId.bind(fileExporterHistoryService));
    rpc.register(RpcMethodEnum.FILEEXPORTERHISTORY_SET_HISTORY_VIEW_MODE, fileExporterHistoryService.setHistoryViewMode.bind(fileExporterHistoryService));
    rpc.register(RpcMethodEnum.FILEEXPORTERHISTORY_SAVE_HISTORY, fileExporterHistoryService.saveHistory.bind(fileExporterHistoryService));
    rpc.register(RpcMethodEnum.FILEEXPORTERHISTORY_DUPLICATE_ENTRY, fileExporterHistoryService.duplicateEntry.bind(fileExporterHistoryService));
    rpc.register(RpcMethodEnum.FILEEXPORTERHISTORY_ADD_NEW_ENTRY, fileExporterHistoryService.addNewEntry.bind(fileExporterHistoryService));
    rpc.register(RpcMethodEnum.FILEEXPORTERHISTORY_TOGGLE_FREEZE, fileExporterHistoryService.toggleFreeze.bind(fileExporterHistoryService));
    rpc.register(RpcMethodEnum.FILEEXPORTERHISTORY_UPDATE_ENTRY_DISPLAY, fileExporterHistoryService.updateEntryDisplay.bind(fileExporterHistoryService));
    rpc.register(RpcMethodEnum.FILEEXPORTERHISTORY_REMOVE_ENTRY, fileExporterHistoryService.removeEntry.bind(fileExporterHistoryService));
    rpc.register(RpcMethodEnum.FILEEXPORTERHISTORY_CLEAR_HISTORY, fileExporterHistoryService.clearHistory.bind(fileExporterHistoryService));
    rpc.register(RpcMethodEnum.FILEEXPORTERHISTORY_SOFT_CLEAR_HISTORY, fileExporterHistoryService.softClearHistory.bind(fileExporterHistoryService));
    rpc.register(RpcMethodEnum.FILEEXPORTERHISTORY_CLEAR_HISTORY_WITH_MODE, fileExporterHistoryService.clearHistoryWithMode.bind(fileExporterHistoryService));
    rpc.register(RpcMethodEnum.FILEEXPORTERHISTORY_GET_HISTORY_FILE_PATH, fileExporterHistoryService.getHistoryFilePath.bind(fileExporterHistoryService));
    rpc.register(RpcMethodEnum.FILEEXPORTERHISTORY_OPEN_HISTORY_FILE, fileExporterHistoryService.openHistoryFile.bind(fileExporterHistoryService));
    rpc.register(RpcMethodEnum.FILEEXPORTERHISTORY_REVEAL_HISTORY_FILE, fileExporterHistoryService.revealHistoryFile.bind(fileExporterHistoryService));

    const fileExporterService = serviceRegistry.get(ServiceEnum.FILE_EXPORTER);
    rpc.register(RpcMethodEnum.FILEEXPORTER_GET_INITIAL_STATE, fileExporterService.getInitialState.bind(fileExporterService));
    rpc.register(RpcMethodEnum.FILEEXPORTER_RUN_EXPORT, fileExporterService.runExport.bind(fileExporterService));
    rpc.register(RpcMethodEnum.FILEEXPORTER_GET_EXPORT_STATUS, fileExporterService.getExportStatus.bind(fileExporterService));
    rpc.register(RpcMethodEnum.FILEEXPORTER_GET_EXPORT_RESULT, fileExporterService.getExportResult.bind(fileExporterService));
    rpc.register(RpcMethodEnum.FILEEXPORTER_KILL_EXPORT, fileExporterService.killExport.bind(fileExporterService));
    rpc.register(RpcMethodEnum.FILEEXPORTER_SIMULATE_FILTERS, fileExporterService.simulateFilters.bind(fileExporterService));
    rpc.register(RpcMethodEnum.FILEEXPORTER_GET_OPEN_EDITOR_FILES, fileExporterService.getOpenEditorFiles.bind(fileExporterService));
    rpc.register(RpcMethodEnum.FILEEXPORTER_GET_GIT_DIFF_FILES, fileExporterService.getGitDiffFiles.bind(fileExporterService));
    rpc.register(RpcMethodEnum.FILEEXPORTER_SYNC_SELECTED_PATHS, fileExporterService.syncSelectedPaths.bind(fileExporterService));
    rpc.register(RpcMethodEnum.FILEEXPORTER_GET_SELECTED_PATHS, fileExporterService.getSelectedPaths.bind(fileExporterService));
    rpc.register(RpcMethodEnum.FILEEXPORTER_CLEAR_SELECTED_PATHS, fileExporterService.clearSelectedPaths.bind(fileExporterService));
