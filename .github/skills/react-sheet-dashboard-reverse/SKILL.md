---
name: react-sheet-dashboard-reverse
...
# 🚀 Agent Skill: React Sheet Dashboard Reverse Prompt Generator (`react-sheet-dashboard-reverse`)
...
📁 `.github/skills/react-sheet-dashboard-reverse/references/reverse-prompt-template.md`
...
- Generating the full specification contract and 7-Module Markdown payload needed as Input 1 (`SPEC_IR`) for the `react-sheet-dashboard-cloner` skill.
...
1. **Load Reference Template**: Read `.github/skills/react-sheet-dashboard-reverse/references/reverse-prompt-template.md`.
