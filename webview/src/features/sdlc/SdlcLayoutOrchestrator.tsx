...
import { LlmFeature } from '@/features/sdlc/domains/llm-chat';
...
export function SdlcLayoutOrchestrator() {
  ...
  useEffect(() => {
    // ----------------------------------------------------------------------
    // STEP 1: CODEBASE CONTEXT (Visualizing Neo4j Impact & Selecting Files)
    // ----------------------------------------------------------------------
      ...
      setLayoutContainers({
        ...
        workspace: {
          top: {
            ...
            isResizable: true, isHiddable: true, maximizeContainer: { isMaximizable: true, isMaximized: false, maximizeScope: 'Workspace' },
          },
          left: {
            visible: true,
            container: (
          ...
          center: {
            ...
            isResizable: false, isHiddable: true, maximizeContainer: { isMaximizable: true, isMaximized: false, maximizeScope: 'Main' },
          },
          right: {
            visible: true,
            container: (
    ...
    // ----------------------------------------------------------------------
    // STEP 2: INSTRUCTIONS (Vibe, BMad, SpecKit Prompting)
    // ----------------------------------------------------------------------
      ...
      setLayoutContainers({
        ...
        workspace: {
          ...
          center: {
            ...
            isResizable: false, isHiddable: false, maximizeContainer: { isMaximizable: true, isMaximized: false, maximizeScope: 'Main' }
          },
          right: { visible: false },
          bottom: { visible: false }
        },
    ...
    // ----------------------------------------------------------------------
    // STEP 3: LLM CHAT (Model Routing & Stream Execution)
    // ----------------------------------------------------------------------
    ...
    // ----------------------------------------------------------------------
    // STEP 4: RESULTS MANAGER (Error Tracking & Session Reloading)
    // ----------------------------------------------------------------------
    ...
    // ----------------------------------------------------------------------
    // CONFIGURATION (Global Policies & Parsers)
    // ----------------------------------------------------------------------
