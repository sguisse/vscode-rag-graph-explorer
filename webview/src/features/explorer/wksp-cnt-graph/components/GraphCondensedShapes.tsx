...
export const CondensedClassNode: React.FC<{ id: string; data: UmlClassNodeData }> = ({ id, data }) => {
  ...
  return (
    <div className={`w-43 bg-card rounded-md shadow-md border-2 ${borderClass} relative transition-all duration-200 opacity-100 overflow-hidden`}>
      ...
      <div className="flex justify-between items-center bg-muted/20 p-1.5 font-mono text-[10px] text-muted-foreground">
