...
export const GraphView: React.FC<GraphViewProps> = ({
    ...
    return (
        <div className={`flex flex-col overflow-hidden bg-[var(--vscode-editor-background)] ${isMaximized ? 'fixed inset-0 z-50 w-screen h-screen' : 'flex-1 h-full'}`}>
            <div className="z-10 relative flex flex-shrink-0 justify-between items-center bg-[var(--vscode-editorGroupHeader-ViewsBackground)] shadow-[0_2px_4px_var(--vscode-widget-shadow)] px-3 border-[var(--vscode-panel-border)] border-b h-10">
                <div className="flex items-center gap-4 h-full text-xs">
                    <div className="flex items-center gap-2">
                        {!isMaximized && (
                            <button
                                id="graph-btn-toggle-sidebar"
            ...
            <div className="relative flex-1 bg-[var(--vscode-editor-background)]">
                <div ref={containerRef} id="graph-cytoscape-canvas" className="absolute inset-0 outline-none" />
